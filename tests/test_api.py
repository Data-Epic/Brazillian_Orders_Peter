...
class TestLoadSellers(unittest.TestCase):
    ...
    def test_with_sample_data(
        self, mock_load_and_transform, mock_upload_csv, mock_get_db
    ) -> None:
        """
        Test the API endpoint for loading sellers data

        Args:
            mock_load_and_transform (MagicMock): Mocked load_and_transform_data function
            mock_upload_csv (MagicMock): Mocked upload_csv function
            mock_get_db (MagicMock): Mocked get_db function
        ...
        mock_upload_csv.return_value = {
            "status": "success",
            "message": "File uploaded successfully",
            "file_path": "path/to/file.csv",
        }

        mock_load_and_transform.return_value = {
            "status": "success",
    ...
    def test_api_load_sellers_data_no_file(self) -> None:
        """
        Test the API endpoint for loading sellers data with no file
    ...
    def test_with_invalid_data(
        ...
        """
        Test the API endpoint for loading sellers data with invalid data
        ...
        data = json.loads(response.data.decode("utf-8"))
        self.assertEqual(
            data["error"], "Invalid file, Kindly provide the Sellers csv file"
        )
...
class TestGetSellers(unittest.TestCase):
    ...
    @patch("src.api.get_db")
    def test_get_sellers(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting sellers data
    ...
    @patch("src.api.get_db")
    def test_get_sellers_empty(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting sellers data when no data is available
    ...
    @patch("src.api.get_db")
    def test_get_sellers_error(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting sellers data when an error occurs
...
class TestLoadCustomers(unittest.TestCase):
    ...
    def test_with_sample_data(
        ...
        """
        Test the API endpoint for loading customers data
        ...
        mock_load_and_transform.return_value = {
            ...
            "data": [
                ...
                },
                {
                    ...
                    "customer_unique_id": "unique2",
                    "customer_zip_code_prefix": "67890",
                    "customer_city": "City2",
    ...
    def test_api_load_customers_data_no_file(self) -> None:
        """
        Test the API endpoint for loading customers data with no file
    ...
    def test_with_invalid_data(
        ...
        """
        Test the API endpoint for loading customers data with invalid data
        ...
        data = json.loads(response.data.decode("utf-8"))
        self.assertEqual(
            data["error"], "Invalid file, Kindly provide the Customers csv file"
        )
...
class TestGetCustomers(unittest.TestCase):
    ...
    @patch("src.api.get_db")
    def test_with_valid_data(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting customers data
    ...
    @patch("src.api.get_db")
    def test_get_customers_empty(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting customers data when no data is available
    ...
    @patch("src.api.get_db")
    def test_get_customers_error(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting customers data when an error occurs
...
class TestLoadOrders(unittest.TestCase):
    ...
    def test_with_sample_data(
        ...
        """
        Test the API endpoint for loading orders data
            ...
            "data": [
                {
                    ...
                    "order_approved_at": "2021-01-01 00:00:00",
                    "order_delivered_carrier_date": "2021-01-01 00:00:00",
                    "order_delivered_customer_date": "2021-01-01 00:00:00",
                    "order_estimated_delivery_date": "2021-01-01 00:00:00",
                },
                {
                    "id": "2",
                    "order_id": "order2",
    ...
    def test_with_invalid_data(
        ...
        """
        Test the API endpoint for loading orders data with invalid data
        ...
        data = json.loads(response.data.decode("utf-8"))
        self.assertEqual(
            data["error"], "Invalid file, Kindly provide the Orders csv file"
        )
...
class TestGetOrders(unittest.TestCase):
    ...
    def test_with_valid_data(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting orders data when data is available
    ...
    @patch("src.api.get_db")
    def test_get_orders_empty(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting orders data when no data is available
    ...
    @patch("src.api.get_db")
    def test_get_orders_error(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting orders data when an error occurs
...
class TestLoadOrderItems(unittest.TestCase):
    ...
    def test_with_sample_data(
        ...
        """
        Test the API endpoint for loading order items data
            ...
            "data": [
                {
                    ...
                    "product_id": "product1",
                    "seller_id": "seller1",
                    "shipping_limit_date": "2021-01-01 00:00:00",
                    "price": 100.0,
                    "freight_value": 10.0,
                },
                {
    ...
    def test_api_load_order_items_data_no_file(self) -> None:
        """
        Test the API endpoint for loading order items data with no file
    ...
    def test_with_invalid_data(
        ...
        """
        Test the API endpoint for loading order items data with invalid data
        ...
        data = json.loads(response.data.decode("utf-8"))
        self.assertEqual(
            data["error"], "Invalid file, Kindly provide the Order Items csv file"
        )
...
class TestLoadOrderPayments(unittest.TestCase):
    ...
    def test_with_sample_data(
        ...
        """
        Test the API endpoint for loading order payments data
    ...
    def test_with_invalid_data(
        ...
        """
        Test the API endpoint for loading order payments data with invalid data
        ...
        data = json.loads(response.data.decode("utf-8"))
        self.assertEqual(
            data["error"], "Invalid file, Kindly provide the Order Payments csv file"
        )
...
class TestGetOrderPayments(unittest.TestCase):
    ...
    def test_with_valid_data(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting order payments data when data is available
    ...
    @patch("src.api.get_db")
    def test_get_order_payments_empty(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting order payments data when no data is available
    ...
    @patch("src.api.get_db")
    def test_get_order_payments_error(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting order payments data when an error occurs
...
class TestLoadProducts(unittest.TestCase):
    ...
    def test_with_sample_data(
        ...
        """
        Test the API endpoint for loading products data
            ...
            "data": [
                {
                    "id": "1",
                    "product_id": "product1",
                    "product_category_name": "category1",
                ...
                },
                {
                    "id": "2",
                    "product_id": "product2",
                    "product_category_name": "category2",
    ...
    def test_api_load_products_data_no_file(self) -> None:
        """
        Test the API endpoint for loading products data with no file
        Args:
            None
        Returns:
            None
    ...
    def test_with_invalid_data(
        ...
        """
        Test the API endpoint for loading products data with invalid data
        ...
        data = json.loads(response.data.decode("utf-8"))
        self.assertEqual(
            data["error"], "Invalid file, Kindly provide the Products csv file"
        )
...
class TestGetProducts(unittest.TestCase):
    ...
    def test_with_valid_data(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting products data when data is available
    ...
    @patch("src.api.get_db")
    def test_get_products_empty(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting products data when no data is available
    ...
    @patch("src.api.get_db")
    def test_get_products_error(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting products data when an error occurs
...
class TestLoadProductCategory(unittest.TestCase):
    ...
    def test_with_sample_data(
        ...
        """
        Test the API endpoint for loading product category data
            ...
            "data": [
                {
                    "id": "1",
                    "product_category_name": "category1",
                    "product_category_name_english": "category1_english",
                },
                {
                    "id": "2",
                    "product_category_name": "category2",
                    "product_category_name_english": "category2_english",
                },
            ],
        }
    ...
    def test_api_load_product_category_data_no_file(self) -> None:
        """
        Test the API endpoint for loading product category data with no file
    ...
    def test_with_invalid_data(
        ...
        """
        Test the API endpoint for loading product category data with invalid data
        ...
        data = json.loads(response.data.decode("utf-8"))
        self.assertEqual(
            data["error"], "Invalid file, Kindly provide the Product Category csv file"
        )
...
class TestGetProductCategory(unittest.TestCase):
    ...
    def test_with_valid_data(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting product category data when data is available
        ...
        self.assertEqual(data["status"], "success")
        self.assertEqual(
            data["message"], "Product Categories data retrieved successfully"
        )
        self.assertEqual(len(data["body"]), 2)
    ...
    @patch("src.api.get_db")
    def test_get_product_category_empty(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting product category data when no data is available
    ...
    @patch("src.api.get_db")
    def test_get_product_category_error(self, mock_get_db) -> None:
        """
        Test the API endpoint for getting product category data when an error occurs
